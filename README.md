...
<img src="https://web-coder.andongmin.com/logo.svg" alt="logo" height="180" />
</a>
...
백준(BOJ) 제출 페이지를 더 편하게 쓰기 위해 만든 **Chrome 확장 프로젝트**입니다.

기존 제출 폼을 그대로 두는 대신, 브라우저 안에서 **문제 확인 → 코드 작성 → 테스트 실행 → 제출**까지 한 화면에서 끝낼 수 있도록 재구성했습니다.
